...
Game jam project for [Ludum Dare 55](https://ludumdare.com/), with the theme of "summoning".

Original code based on [AvO Adventure mk3](https://github.com/shaunanoordin/avo-adventure-mk3).

Created by [Shaun A. Noordin](https://shaunanoordin.com).

## How to Use

Start the web app by accessing `index.html` from your web browser. (Compatible with Chrome 123.)
